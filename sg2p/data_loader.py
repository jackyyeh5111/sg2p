...
class SampleData():
    def __init__(self, args, classes_1600to282, n_sample=1000):
        ...
        # print self.num_distribution.shape
        # print self.captions.shape
        # print self.objs.shape
    ...
    def load_graphs(self, sg_path, classes_1600to282, max_n_objs, max_n_rels):
        ...
        with open(sg_path, 'r') as f:
            entries = pickle.load(f)[:self.n_sample]
    ...
    def load_data(self):
        ...
        with open(self.img_ids_path, 'r') as f:
            img_ids = json.load(f)[:self.n_sample]
