...
class TrainingData():
    def __init__(self, config, batch_size):
        ...
        self.densecap_feats, self.num_distribution, self.captions, self.caption_labels = self.load_data()
    ...
    def load_data(self):
        ...
        with open(self.caption_labels_path, 'rb') as f:
            caption_labels = pickle.load(f)
